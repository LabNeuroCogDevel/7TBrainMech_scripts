...
def run_ts(in_glob, outname, roi_labels=None, func=nolds.dfa):
    outdf = glob_func(in_glob, roi_labels, func=func)
...
def parse_in(args):
    ...
    parser.add_argument('--input', help="input file or file glob", required=True)
...
def main():
    ...
    run_ts(args.input, args.output, args.roilabels, args.method)
