...
matlabbatch{1}.spm.spatial.coreg.estwrite.other = {...
    [strcat(ROI_dir,filesep,'abnormal_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'abnormal_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'brainstem.nii,1')],...
    [strcat(ROI_dir,filesep,'csf.nii,1')],...
    [strcat(ROI_dir,filesep,'frontal_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'frontal_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'insula_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'insula_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'occipital_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'occipital_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'parietal_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'parietal_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'subcortical_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'subcortical_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'temporal_lateral_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'temporal_lateral_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'temporal_medial_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'temporal_medial_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'CAcing_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'CAcing_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'RAcing_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'RAcing_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'PIcing_gm.nii,1')],...
    [strcat(ROI_dir,filesep,'PIcing_wm.nii,1')],...
    [strcat(ROI_dir,filesep,'thalamus.nii,1')],...
    [strcat(ROI_dir,filesep,'basal_ganglia.nii,1')]}';
