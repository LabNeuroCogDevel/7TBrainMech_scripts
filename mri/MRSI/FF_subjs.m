%% OVERVIEW  %%%%%%%
% 20190416 WF - adapt for fabio's data
% 20190207 MP/WF 
...
s = cellfun(@FF_files,csi_visits','Un',0);
...
%% print to file
fid=fopen('/Volumes/Hera/Projects/Collab/7TFF/csi_pfc.txt','w');
for subj_i=1:nsubject
   try
        csi=readtable(s{subj_i}.csi);
        mrid = s{subj_i}.subj_id;
        for roi_j=1:nroi
