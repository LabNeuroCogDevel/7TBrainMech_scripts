...
# 20240422 - Val's UNIT1
/Volumes/Hera/Projects/corticalmyelin_development/sample_info/7T_MP2RAGE_curation_QC.csv:

# 20240227 - allfreqs MIA?
...
### other makefiles (added 20240516)
...
# behave/txt/SR.csv  behave/txt/SSP.csv behave/txt/anti_scored.csv
# behave/txt/ders.csv behave/txt/dts.csv behave/txt/rt18.csv
behave/txt/%.csv:
	make -C behave txt/$(notdir $@)
