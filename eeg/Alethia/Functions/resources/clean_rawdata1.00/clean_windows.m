function [signal,sample_mask] = clean_windows(signal, max_bad_channels, zthresholds, clwin_window_len, window_overlap, max_dropout_fraction, min_clean_fraction, truncate_quant, clwin_step_sizes, shape_range)
...
if ~exist('clwin_window_len','var') || isempty(clwin_window_len) clwin_window_len = 1; end
...
if ~exist('clwin_step_sizes','var') || isempty(clwin_step_sizes) clwin_step_sizes = [0.01 0.01]; end
...
N = clwin_window_len*signal.srate;
wnd = 0:N-1;
