function signal = clean_channels(signal, corr_threshold, noise_threshold, clchan_window_len, max_broken_time, num_samples, subset_size)
...
if ~exist('clchan_window_len','var') || isempty(clchan_window_len) clchan_window_len = 5; end
...
removed_channels(usable_channels) = sum(flagged,2)*clchan_window_len > max_broken_time;
