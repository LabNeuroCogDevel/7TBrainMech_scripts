function [EEG_ERP_variables] = extract_caracteristicas(cfg,filename_out)
...
[sdROIS,sdBL] =extract_sd(cfg);

EEG_ERP_variables = [sdROIS,sdBL(:,2:end)];
%% Acomodar valores en la tabla final
col_header = {'Suj','sdR1','sdR2','sdR3','sd4','sd5',...
    'sdBLR1','sdBLR2','sdBLR3','sdBL4','sdBL5'};
