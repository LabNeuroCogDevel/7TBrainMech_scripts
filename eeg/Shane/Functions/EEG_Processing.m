...
path_data = hera('Projects/7TBrainMech/scripts/eeg/Shane/Prep/ICAwhole/');
CleanICApath = hera('Projects/7TBrainMech/scripts/eeg/Shane/Prep/AfterWhole/ICAwholeClean/');
...
% redo = [11323];
% for i = 1: length(redo) 
%     file(i,:) = sprintf('Projects/7TBrainMech/scripts/eeg/Shane/Prep/ICAwhole/%d', redo(i));
