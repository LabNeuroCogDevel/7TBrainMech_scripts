...
% files = dir(hera('/Projects/7TBrainMech/scripts/eeg/Alethia/Prep/AfterWhole/epochclean_homogenize/*.set'));
% 
...
data.path_to_files = hera('/Projects/7TBrainMech/scripts/eeg/Alethia/Prep/AfterWhole/epochclean_homogenize');
