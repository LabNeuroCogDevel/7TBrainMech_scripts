function [revisar] = epochlean_AudSteadyState(inputfile,epoch_folder,epoch_rj_marked_folder)
revisar = {};
% what file are we using

locs = file_locs_AudSteadyState(inputfile);
...
%extract epochs
EEG = pop_epoch( EEG, {'4' '3' '2'}, [-0.5  2], 'newname', [currentName '_epochs'], 'epochinfo', 'yes');
