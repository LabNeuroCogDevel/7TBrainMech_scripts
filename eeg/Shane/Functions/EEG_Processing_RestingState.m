...
path_data = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/ICAwhole/');
CleanICApath = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/ICAwholeClean/');

EEGfileNames = dir([path_data '/*.set']);
for fidx = 1:length(EEGfileNames)
    filename = EEGfileNames(fidx).name;
    
    locs = file_locs_RestingState(fullfile(path_data,filename));
...
path_data = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/ICAwholeClean/');
epoch_folder =  hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/epoch/');
epoch_rj_marked_folder = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/epochclean/');
...
revisar{currentEEG} = epochlean_RestingState(inputfile,epoch_folder,epoch_rj_marked_folder);
end
...
%% files
folder = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/epochclean/');
...
%% Homogenize Chanloc
datapath = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/ICAwholeClean');
% datapath = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/epochclean');
outpath = hera('Projects/7TBrainMech/scripts/eeg/Shane/Resting_State/AfterWhole/ICAwholeClean_homogenize');
...
for i = 1:length(setfiles)
    ...
    homogenizeChanLoc_RestingState(setfiles{i},correction_cap_location,outpath)
end
