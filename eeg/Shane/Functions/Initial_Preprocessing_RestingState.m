function [channels_removed, data_removed, epochs_removed] = Initial_Preprocessing_RestingState(inputfile, lowBP, topBP, outpath, FLAG, condition, varargin)
...
%% Files
subj_files = file_locs_RestingState(inputfile);
...
if ~exist(subj_files.icawhole, 'file')
    runICAs_RestingState(icawholein, icawholeout)
else
