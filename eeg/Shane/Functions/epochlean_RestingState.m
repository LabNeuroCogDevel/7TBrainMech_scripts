function [revisar] = epochlean_RestingState(inputfile,epoch_folder,epoch_rj_marked_folder)
revisar = {};
% what file are we using

locs = file_locs_RestingState(inputfile);
...
%extract epochs
EEG = pop_epoch( EEG, {'16130', '1', '0'}, [-0.5  2], 'newname', [currentName '_epochs'], 'epochinfo', 'yes');
