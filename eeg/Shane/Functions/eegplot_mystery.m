function [z,map]=eegplot_mystery(mag,ch,unorm,ch_disp,method,color_res)
% 20200626WF - added "_mystery", last modified 20200207. from where?
% can conflict with eeglab's eegplot used from pop_eegplot
...
if(isempty(ch)),
    ...
    figure;imshow(imread('brain.jpg'));
    nch=length(mag);
...
cx=chx;cy=chy;
chx=[chx ;  zeros(1089,1)];
chy=[chy ;  zeros(1089,1)];
