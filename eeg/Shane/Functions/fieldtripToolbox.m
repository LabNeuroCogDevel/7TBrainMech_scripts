...
save(hera('Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/fieldtrip_all_power_1_2_seconds.mat'), 'all_power');
...
fieldtripT = table(idvalues, all_power'); 

fieldtripT = fieldtripT(fieldtripT.Var2 ~= 0, :);

writetable(fieldtripT, hera('Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Filedtrip_Table_all.csv'));
